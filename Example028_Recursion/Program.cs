...
// string path = "D:/УЧЕБА/I четверть/5. Знакомство с языками программирования/Задачи/Examples/Example001_HelloConsole";
...
//     }
// }
// string path = @"D:\УЧЕБА\I четверть\5. Знакомство с языками программирования\Задачи\Examples";
// CatalogInfo(path);
